...
To start the back, open the midterm folder and execute the following command lines:
`yarn add`
`yarn start`
...
To start the front, go to midterm1/front and execute the following command lines:
`yarn add`
`yarn start`
...
`cd/data
mongoimport -d <name of the database (you create this name)> -c <name of the collection (you create this name)> --jsonArray --file <name of the existing file to extract the data>`
